...
#train_script='/vol/research/iview-data/Ope/project/Deep_Helmholtz/train.py'
#root_dir='/vol/research/iview-data/Ope/'
#save_dir='/vol/research/iview-data/Ope/Helmholtz_save/mvs'
#train_list='/vol/research/iview-data/Ope/project/Deep_Helmholtz/Dataset/train.txt'
#val_list='/vol/research/iview-data/Ope/project/Deep_Helmholtz/Dataset/val.txt'

#root_dir='/Users/culsu/Documents/UNI_stuff/Surrey/Courses/MSC_Project/src/downloads/Helmholtz_dataset/'
...
torchrun  --standalone \
          ...
          --planes_in_stages '64, 32, 8' --sync_bn --log_freq 50 --num_workers $num_workers # --ckpt $ckpt
